  ...
  context "#get_weather", :vcr do
    ...
    describe "with invalid api-key" do
      ...
      it "must raise Unauthorized Error" do
        expect do
          subject.get_weather(city: "Campinas")
        end.to raise_error Ropenweather::Unauthorized
      end
    end
    ...
    describe "with valid api-key" do
      it "with invalid city must raise CityNotFound Error" do
        expect do
          subject.get_weather(city: "1nv4l1d1-c1ty")
        end.to raise_error Ropenweather::CityNotFound
      end
